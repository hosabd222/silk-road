				...
				<?php if ( ! rocket_get_constant( 'WP_ROCKET_WHITE_LABEL_ACCOUNT' ) ) { ?>
					<div class="wpr-field">
						<div class="wpr-flex wpr-flex--egal">
							...
							<div>
								<a href="http://zhaket.com/support" class="wpr-button wpr-button--icon wpr-button--small wpr-button--blue wpr-icon-help wpr-js-askSupport" target="_blank"><?php _e('Ask support', 'rocket'); ?></a>
							</div>
						</div>
					</div>
				<?php } ?>
