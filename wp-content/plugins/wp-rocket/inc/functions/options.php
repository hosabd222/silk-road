...
function rocket_valid_key() {
	...
	$product_token = '744960c8-c318-41ce-bf26-7f9fb827dbde';
	$settings = [
		'name'          => __('WP Rocket', 'rocket'),
		'slug'          => 'zhk_guard_register_rocket',
		'parent_slug'   => 'options-general.php',
		'text_domain'   => 'rocket',
		'product_token' => $product_token,
		'option_name'   => 'zhk_rocket_settings'
	];
	Rocket_Tester::instance($settings);

	if( Rocket_Tester::is_activated() ) {
		return true;
	}
	return false;
