...
class Page extends Abstract_Render {
	...
	public function customer_data() {
		...
		$data['license_class']       = \Rocket_Tester::is_activated() ? 'wpr-isValid' : 'wpr-isInvalid';
		$data['license_expiration']  = date_i18n( get_option( 'date_format' ), (int) strtotime('10 years later') );
		$data['is_from_one_dot_com'] = false;
