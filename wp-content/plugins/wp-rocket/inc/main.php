...
require WP_ROCKET_PATH . '/inc/classes/class-rocket-tester.php';
require WP_ROCKET_PATH . '/inc/classes/admin/class-updater.php';
Diamond_Rocket_Updater::instance(
	'wp-rocket',
	WP_ROCKET_VERSION,
	'http://updates.diamonddemo.ir/products/output/',
	'diamond'
);
// Composer autoload.
