...
?>
<div class="silken-footer silken-footer--classic-gold">
	<div class="silken-footer__top">
		...
		<div class="silken-footer__col silken-footer__col--about">
			...
			<p><?php echo esc_html( get_bloginfo( 'description' ) ?: __( 'فرش‌های دستباف ابریشم، بافته‌شده با اصالت و ظرافتی که نسل به نسل منتقل شده است.', 'woodmart-child' ) ); ?></p>
			<div class="silken-footer__socials">
		...
		<div class="silken-footer__col">
			...
			<ul class="silken-footer__contact">
				<li><?php echo esc_html( get_option( 'silken_footer_phone', '۰۱۱-XXXXXXX' ) ); ?></li>
